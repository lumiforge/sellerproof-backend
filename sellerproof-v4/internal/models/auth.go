...
// ForgotPasswordResponse represents a response for forgot password request
// @Description Forgot password response
type ForgotPasswordResponse struct {
	Message string `json:"message"`
}

// ResetPasswordRequest represents a request to reset password using code
...
// ResetPasswordResponse represents a response for reset password request
