...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.GetUserOrganizationsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SwitchOrganizationRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.SwitchOrganizationResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/organization/members/{user_id}/status": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateOrganizationNameRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.UpdateOrganizationNameResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.GetSubscriptionResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.RestoreVideoRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.RestoreVideoResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/video/revoke": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Revoke video request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.RevokeVideoRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.RevokeVideoResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.GetTrashVideosResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ReplaceVideoRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.GetSubscriptionResponse": {
            ...
            "properties": {
                ...
                "usage": {
                    "$ref": "#/definitions/models.StorageUsage"
                }
            }
        },
        "models.GetTrashVideosResponse": {
            ...
            "properties": {
                ...
                "videos": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.TrashVideo"
                    }
                }
            }
        },
        "models.GetUserOrganizationsResponse": {
        ...
        "models.SwitchOrganizationRequest": {
            "description": "Switch organization request",
            "type": "object",
            "properties": {
                "org_id": {
        ...
        "models.SwitchOrganizationResponse": {
        ...
        "models.UpdateOrganizationNameRequest": {
            "description": "Update organization name request",
            "type": "object",
            "properties": {
                "name": {
        ...
        "models.UpdateOrganizationNameResponse": {
