...
export SP_ENTRY
# S3
export SP_OBJSTORE_BUCKET_START
export SP_OBJSTORE_BUCKET_PRO
export SP_OBJSTORE_BUCKET_ENTERPRISE
export SP_SA_KEY_ID
export SP_SA_KEY
# YDB
...
REQUIRED_ENV := SP_SA SP_FUNC SP_ENTRY SP_YDB_ENDPOINT SP_YDB_DATABASE_PATH SP_PRESIGN_TTL_FOR_ARCHIVE_SECONDS SP_OBJSTORE_BUCKET_START SP_OBJSTORE_BUCKET_PRO SP_OBJSTORE_BUCKET_ENTERPRISE SP_PRESIGN_TTL_SECONDS SP_SA_KEY_ID SP_SA_KEY SP_JWT_SECRET_KEY SP_POSTBOX_ENDPOINT SP_POSTBOX_REGION SP_SA_KEY_ID SP_SA_KEY SP_APP_LOGIN_URL SP_EMAIL_FROM TELEGRAM_BOT_TOKEN TELEGRAM_CHAT_ID
