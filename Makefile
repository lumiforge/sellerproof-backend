...
REQUIRED_ENV := SP_SA SP_FUNC SP_ENTRY SP_YDB_ENDPOINT SP_YDB_DATABASE_PATH SP_PRESIGN_TTL_FOR_ARCHIVE_SECONDS SP_OBJSTORE_BUCKET_NAME SP_PRESIGN_TTL_SECONDS SP_JWT_SECRET_KEY  FRONTEND_BASE_URL GRPC_PORT SP_POSTBOX_ENDPOINT SP_POSTBOX_REGION SP_APP_LOGIN_URL SP_EMAIL_FROM
...
ENV_ARGS = "SP_SA=$$SP_SA,SP_FUNC=$$SP_FUNC,SP_ENTRY=$$SP_ENTRY,SP_YDB_ENDPOINT=$$SP_YDB_ENDPOINT,SP_YDB_DATABASE_PATH=$$SP_YDB_DATABASE_PATH,SP_PRESIGN_TTL_FOR_ARCHIVE_SECONDS=$$SP_PRESIGN_TTL_FOR_ARCHIVE_SECONDS,SP_OBJSTORE_BUCKET_NAME=$$SP_OBJSTORE_BUCKET_NAME,SP_PRESIGN_TTL_SECONDS=$$SP_PRESIGN_TTL_SECONDS,JWT_SECRET_KEY=$$JWT_SECRET_KEY,POSTBOX_ACCESS_KEY_ID=$$POSTBOX_ACCESS_KEY_ID,POSTBOX_SECRET_ACCESS_KEY=$$POSTBOX_SECRET_ACCESS_KEY,POSTBOX_FROM_EMAIL=$$POSTBOX_FROM_EMAIL,FRONTEND_BASE_URL=$$FRONTEND_BASE_URL,GRPC_PORT=$$GRPC_PORT,SP_POSTBOX_ENDPOINT=$$SP_POSTBOX_ENDPOINT,SP_POSTBOX_REGION=$$SP_POSTBOX_REGION,SP_APP_LOGIN_URL=$$SP_APP_LOGIN_URL,SP_EMAIL_FROM=$$SP_EMAIL_FROM"
