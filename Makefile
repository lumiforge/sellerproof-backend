...
REQUIRED_ENV := SP_SA SP_FUNC SP_ENTRY SP_YDB_ENDPOINT SP_YDB_DATABASE_PATH SP_PRESIGN_TTL_FOR_ARCHIVE_SECONDS SP_OBJSTORE_BUCKET_NAME SP_PRESIGN_TTL_SECONDS SP_JWT_SECRET_KEY POSTBOX_ACCESS_KEY_ID POSTBOX_SECRET_ACCESS_KEY POSTBOX_FROM_EMAIL FRONTEND_BASE_URL GRPC_PORT
