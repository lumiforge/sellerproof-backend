...
REQUIRED_ENV := SP_SA SP_FUNC SP_ENTRY SP_YDB_ENDPOINT SP_YDB_DATABASE_PATH SP_PRESIGN_TTL_FOR_ARCHIVE_SECONDS SP_OBJSTORE_BUCKET_NAME SP_PRESIGN_TTL_SECONDS SP_JWT_SECRET_KEY  SP_POSTBOX_ENDPOINT SP_POSTBOX_REGION SP_APP_LOGIN_URL SP_EMAIL_FROM
...
ENV_ARGS = "SP_SA=$$SP_SA,SP_FUNC=$$SP_FUNC,SP_ENTRY=$$SP_ENTRY,SP_YDB_ENDPOINT=$$SP_YDB_ENDPOINT,SP_YDB_DATABASE_PATH=$$SP_YDB_DATABASE_PATH,SP_PRESIGN_TTL_FOR_ARCHIVE_SECONDS=$$SP_PRESIGN_TTL_FOR_ARCHIVE_SECONDS,SP_OBJSTORE_BUCKET_NAME=$$SP_OBJSTORE_BUCKET_NAME,SP_PRESIGN_TTL_SECONDS=$$SP_PRESIGN_TTL_SECONDS,JWT_SECRET_KEY=$$JWT_SECRET_KEY,SP_POSTBOX_ENDPOINT=$$SP_POSTBOX_ENDPOINT,SP_POSTBOX_REGION=$$SP_POSTBOX_REGION,SP_APP_LOGIN_URL=$$SP_APP_LOGIN_URL,SP_EMAIL_FROM=$$SP_EMAIL_FROM"
